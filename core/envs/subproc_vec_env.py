...
class MultiprocessingVecEnv(VecEnv):
    ...
    def __init__(self, env_fns: List[Callable[[], gym.Env]]):
        ...
        :param env_fns (callable): Functions to create environments that will be run in subprocesses.
        :param queue (multiprocessing.Queue): Multiprocessing queue.
        :param lock(multiprocessing.Lock): Multiprocessing lock.
        """
        self.waiting = False
        self.closed = False
        n_envs = len(env_fns)
    ...
    def _get_target_remotes(self, indices: VecEnvIndices) -> List[Any]:
        ...
        :param indices (VecEnvIndices): refers to indices of envs.
