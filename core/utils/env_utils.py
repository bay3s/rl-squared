...
def make_env(env_name: str, seed: int, rank: int, log_dir: str, allow_early_resets: bool) -> Callable:
    """
...
def make_vec_envs(
    env_name: str, seed: int, num_processes: int, gamma: float, log_dir: str, device: str, allow_early_resets: bool
) -> PyTorchVecEnv:
    """
    ...
    Args:
        ...
        log_dir (str): Directory for logging.
        device (str): Device to use with PyTorch tensors.
        allow_early_resets (bool): Allows resetting the environment before it is done.
