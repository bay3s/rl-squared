...
from core.networks.modules.distributions.categorical.fixed_categorical import FixedCategorical
...
class Categorical(nn.Module):
    ...
    def __init__(self, num_inputs: int, num_outputs: int):
        ...
        self.linear = init_module(
            nn.Linear(num_inputs, num_outputs), nn.init.orthogonal_, lambda x: nn.init.constant_(x, 0), gain=0.01
        )
        pass
